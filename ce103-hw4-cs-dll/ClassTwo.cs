...
namespace ce103_hw4_cs_dll
{
    public class ClassTwo
    {
        ...
        **/
        ...
        /**
           @name   strrev (strrev_cs_imported)
        ...
        **/
        ...
        public string strrev_cs_imported(string fiStr)
        {
        ...
        **/
        public int strlen_cs_imported(string fiStr)
        {
        ...
        **/
        public string strcat_cs_imported(string fiDest, string fiSrc)
        {


            var c = fiDest.ToCharArray();
            var v = new char[fiDest.Length + 1];
        ...
        **/
        public int strcmp_cs_imported(string fiLhs, string fiRhs)
        {
            return ce103_strcmp_cpp(fiLhs, fiRhs);
        }

        /**
            @name  strcpy (strcpy_cs_imported)
        ...
        **/
        public string strcpy_cs_imported(string foDestination, string fiSource)
        {
            var c = foDestination.ToCharArray();
            var v = new char[foDestination.Length + 1];
            for (int i = 0; i < c.Length; i++)
            {
                v[i] = c[i];
            }
            v[foDestination.Length] = '\0';
        ...
        /**
         * @name    hex2bin (hexToBin_cs_imported)
         * 
         ...
         **/
        public void hexToBin_cs_imported(string fiHex, int fiHexLen, byte[] foBin)
        {
            ce103_hex2bin_cpp(fiHex, fiHexLen, foBin);
        }

        /**
        * @name    bin2hex (binToHex_cs_imported)
        * 
        ...
        **/
        public void binToHex_cs_imported([In] byte[] fiBin, int fiBinLen, [Out] char[] foHex)
        {
